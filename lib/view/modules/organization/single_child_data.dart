...
class SingleChildDataOrganization extends StatefulWidget {
  ...
  SingleChildDataOrganization({super.key, required this.selectedChildId});

  @override
  State<SingleChildDataOrganization> createState() =>
      _SingleChildDataOrganizationState();
}

class _SingleChildDataOrganizationState
    extends State<SingleChildDataOrganization> {
                    ...
                    child: Column(
                      children: [
                        ...
                        Align(
                            ...
                            child:
                                customeText(text: "Child Details", size: 28)),
                        const Gap(20),
                        Align(
                          alignment: Alignment.topLeft,
                          child: IconButton(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      customeText(
                                          text: "Joined Date", size: 20),
                                      customeText(
                                          text: "Known location", size: 20),
                                      customeText(
                                          text: "Bkood Group", size: 20),
                                      customeText(
                                          text: "Orphan Type", size: 20),
                                      customeText(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      customeText(
                                          text: childData.nickNmae, size: 20),
                                      customeText(
                                          text: "${childData.age}", size: 20),
                                      customeText(
                                          text: childData.gender, size: 20),
                                      customeText(
                                          text: childData.dirthdate, size: 20),
                                      customeText(
                                          text: childData.joinDate, size: 20),
                                      customeText(
                                          text: childData.location, size: 20),
                                      customeText(
                                          text: childData.bloodGroup, size: 20),
                                      customeText(
                                          text: childData.orphanType, size: 20),
                                      customeText(
                                          text: childData.adoptionStatus,
                                          size: 20),
                                    ],
                                  )
                                ],
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        customeText(
                                            ...
                                            size: 20),
                                        customeText(
                                            text: healthData?.diseases,
                                            size: 20),
                                        customeText(
                                            text: healthData?.disabilities,
                                            size: 20),
                                        customeText(
                        ...
                        customeGradientButtom(
                            onpressed: () async {
                              await serviceProviderinstence
                                  .addAdoptionRequestToFirebase(
                                      AdoptionModel(userType: "Organization",
                                          image:
                        ...
                        Gap(40),
                        customeText(
                            text: "Send a request for adoption of this child")
                      ],
                    ),
                  ),
                );
